...
<!-- Login -->
            <div class="tab"><h5>Login Info:</h5>
                ...
                <p>
                    <input class="form-control" tabindex="0" placeholder="Password..." data-toggle="password" type="password" id="pswd" name="pswd" maxlength="100" size="20" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" oninput="this.className = 'form-control'"/>
                    <?php //echo "$pswdErr";?>
                </p>
